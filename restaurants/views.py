...
from restaurants.pinterest_post import Pinterest
...
class GetTags(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        acess_key=restaurants.clarifai_tag_suggestions.get_access_token('CLARIFAI_API_KEY')
        tags=restaurants.clarifai_tag_suggestions.get_tags_suggestions(acess_key,image_url)
        print(tags)
        return JsonResponse(tags, safe=False)
# @POST
